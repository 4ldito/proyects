                ...
                <ul class="lista-precios">
                    <div class="tabla-precio columns-4">
                        <li>
                            ...
                            <div class="orden">
                                ...
                                <input type="number" name="pase_dia" id="pase_dia" min="0" placeholder="0">
                            </div>
                        </li>
                    </div>
                    ...
                    <div class="tabla-precio columns-4">
                        <li>
                            ...
                            <input type="number" name="pase_completo" id="pase_completo" min="0" placeholder="0">
                        </li>
                    </div>

                    <div class="tabla-precio columns-4">
                        <li>
                            <h3>Dos Días (Viernes y Sábado)</h3>
                            <p class="numero">$35</p>
                            <ul>
                                <li><i class="fas fa-check"></i>Comida Gratis</li>
                                <li><i class="fas fa-check"></i>Todas las conferencias</li>
                            ...
                            <input type="number" name="pase_dos_dias" id="pase_dos_dias" min="0" placeholder="0">
                        </li>
                    </div>
                </ul>
            </div>
            ...
            <div class="resumen">
                ...
                <div class="caja">
                    <div class="finalizar-compra">
                        <div class="extras">
                            <div class="orden">
                                <label for="camisa-evento">Camisa del evento $10 <small>(¡15% de
                                        descuento!)</small></label>
                                <input type="number" name="camisa-evento" id="camisa-evento" min="0" placeholder="0"
                                    size="3">
                            </div>
                            ...
                            <div class="orden">
                                <label for="etiquetas">Paquete de 10 etiquetas $2 <small>(HTML5, CSS3, JavaScript,
                                        Chrome,
                                        etc.)</small></label>
                                <input type="number" name="etiquetas" id="etiquetas" min="0" placeholder="0" size="3">
                            </div>
                            ...
                            <div class="abajo">
                                <input type="button" value="Calcular" id="calcular" class="btn margin">
                            </div>
                        </div>
                        <!--extras-->
                        ...
                        <div class="total">
                            <p>Resumen:</p>
                            <div id="lista-productos" class="arreglar">
                                <!-- listaproductos -->
                            </div>
                            <p>Total:</p>
                            <div id="suma-total" class="precio">
                                <!-- sumatotal -->
                            </div>
                        </div>
                        <!--Total-->
                    ...
                    <!--Caja-->
                    <div class="pagar">
                        <input type="submit" value="Confirmar Pago" class="btn" id="confirmar_pago">
                    </div>
                </div>
            </div>
            <!--resumen-->
